            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-zinc-400 max-w-2xl mx-auto">
                        My technical proficiency spans across Data Science, Machine Learning, and Full Stack Development.
                    </p>
                </motion.div>

                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <SkillCard title="Languages" skills={DATA.skills.languages} delay={0} />
                    <SkillCard title="Machine Learning" skills={DATA.skills.ml_dl} delay={0.1} />
                    <SkillCard title="Frameworks" skills={DATA.skills.frameworks} delay={0.2} />
                    <SkillCard title="Tools & Platforms" skills={[...DATA.skills.tools, ...DATA.skills.platforms]} delay={0.3} />
                </div>
            </div>
        </section>
    );
